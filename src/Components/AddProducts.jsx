...
export default function ProductForm() {
  ...
  const categories = ["All","Men","Beauty&Fashion","Electronics","Women","Tech","Auto","Kids","Electronics",, "Clothing", "Books", "Home Appliances", "Beauty"];
  const countries = ["Pakistan","United States", "Canada", "United Kingdom", "Australia", "India", "Germany", "France"]; // Add more countries as needed
